...
if($slider->rowCount() == 0 ) {
    header("Location:pages.php?sayfa=sliderlar");
}
?>
<title>Slider Düzenle | <?=$ayar['site_baslik']?></title>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="ti-layout-slider "></i> Slider Düzenle</h4>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <div class="card-body p-b-0">
                    <h4 class="card-title">Slider Düzenle <span style="font-size:15px;">( <i class="flag-icon-<?php echo $lang['flag'] ?>" style="width:18px; height:13px; display: inline-block; margin-right: 10px; "></i><?=$lang['baslik']?> Dilinde ) </span></h4>
                ...
                <!-- Tab panes -->
                <form action="support/post/update/slider-duzenle.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" <?php if ($row['text_status'] == 1) {?> checked <?php }?> id="slidYazi" class="js-switch" data-color="#f62d51" name="text_status" value="1" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" <?php if ($row['dark_bg'] == 1) {?> checked <?php }?> id="bgkarartma" class="js-switch" data-color="#f62d51" name="dark_bg" value="1" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="number"  id="sirasiSlider"  name="sira" value="<?=$row['sira']?>" required class="form-control" min=1 oninput="validity.valid||(value='');"/>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 ">
                                    <div class="form-group">
                                        ...
                                        <select name="area" id="yaziAlani" class="form-control">
                                            <option <?php if ($row['area'] == 'left') {?> selected <?php }?> value="left">Sola Hizalı</option>
                                            <option <?php if ($row['area'] == 'center') {?> selected <?php }?> value="center">Ortalı</option>
                                            <option <?php if ($row['area'] == 'right') {?> selected <?php }?> value="right">Sağa Hizalı</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" name="url" class="form-control" id="linkArea" value="<?=$row['url']?>" placeholder="Boş bırakırsanız buton çıkmaz" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <div class="input-group" >
                                            <input type="text" name="button_text" class="form-control" id="butonText" value="<?=$row['button_text']?>" placeholder="Örn : DETAYLI BİLGİ">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 ">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div style="width: 100%; height: auto; background-color: #F9F9F9; border:1px solid #EBEBEB; padding: 15px; 0 15px 0; text-align: center;  margin-top:8px;">
                                            <img src="../images/slider/<?=$row['gorsel']?>" style="width: 100%; ">
                                            <br><br>
                                            <small class="form-control-feedback text-info" style="font-size:13px; font-weight: 400">  İdeal Ebat : 1920x660 veya 1920x800</small>
                                        </div>
