...
<title>Kargo Bilgisi Düzenle | <?=$ayar['site_baslik']?></title>
<?php
$kargoBilgisi = $db->prepare("select * from kargo where id='$_GET[kargo_id]'");
$kargoBilgisi->execute();
$kargo = $kargoBilgisi ->fetch(PDO::FETCH_ASSOC);

$siparisCikar = $db->prepare("select * from siparis_urunler where id='$kargo[siparis_urun_id]'");
$siparisCikar->execute();
$urun = $siparisCikar ->fetch(PDO::FETCH_ASSOC);
?>

<?php
if($kargoBilgisi->rowCount() == 0 ) {
    header("Location:pages.php?sayfa=siparisler");
}
?>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="ti-truck"></i> Kargo Bilgisi Düzenle</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Kargo Bilgisi Düzenle</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <form action="support/post/update/kargo-bilgisi-duzenle.php" class="form-horizontal form-bordered" method="post">


                    <input type="hidden" name="kargo_id" value="<?=$kargo['id']?>">
                    <input type="hidden" name="sip_urun_id" value="<?=$urun['id']?>">
                    
                    <h3 class="card-title">Kargo Bilgisi Düzenle <span style="font-size:15px;"></span></h3>
                    <hr>
                    <div class="form-body">
                      ...
                      <div class="row">
                          ...
                          <div class="form-group col-md-6">
                              ...
                              <br><br>
                              <input type="text" class="form-control" id="kargoAdi" name="kargo_adi"  required value="<?=$kargo['kargo_adi']?>">
                          </div>
                          <div class="form-group col-md-6">
                              <label for="recipient-name" class="control-label" style="font-weight: 500">Kargo Takip No :</label>
                              <br><br>
                              <input type="text" class="form-control" id="recipient-name" name="takip_no" value="<?=$kargo['takip_no']?>" required >
                          </div>
                          <div class="form-group col-md-6">
                              ...
                              <br><br>
                              <textarea class="textarea_editor form-control" id="message-text" rows="4" name="eposta_mesaj"  ><?=$kargo['eposta_mesaj']?></textarea>
                          </div>
                          <div class="form-group col-md-6">
                              ...
                              <br><br>
                              <textarea class="textarea_editor form-control" id="message-tex2t" rows="6" name="sms_mesaj"  ><?=$kargo['sms_mesaj']?></textarea>
                          </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-info" name="kargodegis">
