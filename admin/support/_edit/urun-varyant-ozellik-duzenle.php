...
<title>Varyant Seçeneği Düzenle | <?=$ayar['site_baslik']?></title>
<?php
$bilgiCek = $db->prepare("select * from varyant_oz where id='$_GET[ozellik_id]' ");
$bilgiCek->execute();
$row = $bilgiCek->fetch(PDO::FETCH_ASSOC);

$degerCek = $db->prepare("select * from varyant where id='$row[varyant_id]'");
$degerCek->execute();
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="mdi mdi-table-edit"></i> Varyant Seçeneği Düzenle</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Varyant Seçeneği Düzenle</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <form action="support/post/update/varyant-ozellik-duzenle.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                    ...
                    <h3 class="card-title">Varyant Seçeneği Düzenle</h3>
                    <hr>
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="ozellik" required class="form-control" id="ozellikAd" value="<?=$row['ozellik']?>">
                            </div>
                        </div>
