...
<title>Sayfa Yönetimi | <?=$ayar['site_baslik']?></title>
<?php
$Sayfa = @intval($_GET['page']); if(!$Sayfa) $Sayfa = 1;
$Say = $db->query("select * from htmlsayfa where dil='$_SESSION[dil]' order by id DESC");
...
$GorunenSayfa = 5;
$ara = $_GET['search'];
$listele_tablo = $db->query("select * from htmlsayfa where (baslik like '%$ara%' ) and dil='$_SESSION[dil]' order by id DESC limit $Goster,$Limit");
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="ti-files"></i> HTML Sayfalar</h4>
    </div>
...
<form action="support/post/multi-delete/sayfalari-sil.php" method="post">
<div class="row">
    ...
    <div class="col-md-12" style="text-align: left" >
        ...
        <a role="button" href="pages.php?sayfa=sayfaekle" class="btn btn-info m-b-15" style="color:#FFF" ><i class="fa fa-plus-circle"></i> Yeni Sayfa Ekle</a>
    ...
    <div class="col-12">
        <div class="card" >
            <div class="card-body bg-secondary" >
                ...
                <h3 class="card-title m-b-25">Sayfa Yönetimi <span style="font-size:15px;">( <i class="flag-icon-<?php echo $lang['flag'] ?>" style="width:18px; height:13px; display: inline-block; margin-right: 10px; "></i><?=$lang['baslik']?> Dilinde ) </span></h3>
                <h6 class="card-subtitle">Bu alanda oluşturuğunuz sayfaları görebilirsiniz. Arama yapmak için sayfanın altına gidiniz.</h6>
                ...
                <div class="table-responsive"  >
                    <table class="table table-bordered table-striped" style="font-family: 'Open Sans', Arial; margin-bottom: 0 !important;" >
                        ...
                        <tr>
                            ...
                            <th  style="border-top: 0 !important; border-bottom: 0 !important; text-align: center">SEO URL</th>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 500; text-align: center">
                                <a href="<?=$ayar['site_url']?>sayfa/<?=$row['seo_url']?>" target="_blank"><span class="btn btn-sm btn-info"><i class="fa fa-link"></i> <?=$ayar['site_url']?>sayfa/<?=$row['seo_url']?></span></a>
                            </td>
                            ...
                            <td class="text-nowrap" style="text-align: center; border-right: 0 !important;">
                                <a  href="pages.php?sayfa=sayfa&sayfa_id=<?=$row['id']?>" class="btn btn-sm btn-info" style="color:#FFF"><i class="fa fa-pencil text-inverse"></i> Düzenle </a>
                    ...
                    <?php if($Sayfa > 1){?>
                        ...
                        <li class="page-item"><a class="page-link" href="pages.php?sayfa=sayfalar&page="><?=$diller['sayfalama-ilk']?></a></li>
                        <li class="page-item"><a class="page-link" href="pages.php?sayfa=sayfalar&page=<?=$Sayfa - 1?>"><?=$diller['sayfalama-onceki']?></a></li>
                    ...
                    for($i = $Sayfa - $GorunenSayfa; $i < $Sayfa + $GorunenSayfa +1; $i++){ if($i > 0 and $i <= $Sayfa_Sayisi){
                        if($i == $Sayfa){
                            ...
                            <li class="page-item active" aria-current="page">
                              <a class="page-link" href="pages.php?sayfa=sayfalar&page='.$i.'">'.$i.'<span class="sr-only">(current)</span></a>
                            </li>
                            ...
                            echo '
                    <li class="page-item"><a class="page-link" href="pages.php?sayfa=sayfalar&page='.$i.'">'.$i.'</a></li>
                    ';
                        }
                    }
                    }
                    ...
                    <?php if($listele_tablo->rowCount() <=0) { } else { ?>
                        <?php if($Sayfa != $Sayfa_Sayisi){?>
                            ...
                            <li class="page-item"><a class="page-link" href="pages.php?sayfa=sayfalar&page=<?=$Sayfa + 1?>"><?=$diller['sayfalama-sonraki']?></a></li>
                            <li class="page-item"><a class="page-link" href="pages.php?sayfa=sayfalar&page=<?=$Sayfa_Sayisi?>"><?=$diller['sayfalama-son']?></a></li>
                ...
                <div class="alert alert-info" style="font-weight: 400">
                  Sayfa bulunamadı!
                    <?php if(isset($_GET['search'])) {?>
                        <a href="pages.php?sayfa=sayfalar">Geri Dön</a>
                    <?php }?>
                </div>
                <?php }?>
...
<div class="card p-l-5 p-b-15 p-t-20 bg-secondary">
    ...
    <form method="get" action="pages.php?" >
        <div class="form-row align-items-center">
            ...
            <div class="col-auto">
                <input type="hidden" class="form-control mb-2" id="inlineFormInput" name="sayfa" value="sayfalar">
            </div>
...
<script type="text/javascript">
    ...
    function deletebutton(sayfaid){
        ...
        swal({
            ...
            if (isConfirm) {
                window.location.href = "support/post/delete/sayfa-sil.php?sayfa=success&id="+sayfaid;
            } else {
...
<?php if( $_GET['status']=='success'){ ?>
    ...
    <meta http-equiv="refresh" content="1; URL=pages.php?sayfa=sayfalar">
<?php }?>
