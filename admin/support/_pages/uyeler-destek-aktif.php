...
<title>Açık Destek Talepleri | <?=$ayar['site_baslik']?></title>
<?php
$Sayfa = @intval($_GET['page']); if(!$Sayfa) $Sayfa = 1;
$Say = $db->query("select * from uyeler_destek where durum='1' order by tarih desc");
...
$GorunenSayfa = 5;
$ara = $_GET['search'];
$listele_tablo = $db->query("select * from uyeler_destek where (support_id like '%$ara%' or konu like '%$ara%') and durum='1' order by tarih desc limit $Goster,$Limit");
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="mdi mdi-tooltip-text"></i> Açık Destek Talepleri</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Açık Destek Talepleri</li>
            </ol>
        </div>
    </div>
</div>

<form action="support/post/multi-delete/destek-aktif-sil.php" method="post">
<div class="row">
    ...
    <div class="col-12">
        <div class="card" >
            <div class="card-body bg-secondary" >
                ...
                <h3 class="card-title m-b-25"><i class="fa fa-dot-circle-o" style="color: red"></i> Açık Destek Talepleri <span style="font-size:15px;">( <?=$destektalepleri->rowCount()?> ) </span></h3>
                <h6 class="card-subtitle">Bu alanda üyelerinizin size göndermiş oldukları destek mesajlarını görebilirsiniz.</h6>
            ...
            <div class="card-body" style="padding: 15px !important;">
                ...
                <div class="table-responsive"  >
                    <table class="table table-bordered table-striped" style="font-family: 'Open Sans', Arial; margin-bottom: 0 !important;" >
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 400; text-align: center;">
                                <?php if($row['durum'] == '1' ) {?>
                                    <div class="btn btn-sm btn-danger"><i class="fa fa-dot-circle-o"></i> Açık</div>
                                <?php }?>
                                <?php if($row['durum'] == '0' ) {?>
                    ...
                    <?php if($Sayfa > 1){?>
                        ...
                        <li class="page-item"><a class="page-link" href="pages.php?sayfa=aktifdestek&page="><?=$diller['sayfalama-ilk']?></a></li>
                        <li class="page-item"><a class="page-link" href="pages.php?sayfa=aktifdestek&page=<?=$Sayfa - 1?>"><?=$diller['sayfalama-onceki']?></a></li>
                    ...
                    for($i = $Sayfa - $GorunenSayfa; $i < $Sayfa + $GorunenSayfa +1; $i++){ if($i > 0 and $i <= $Sayfa_Sayisi){
                        if($i == $Sayfa){
                            ...
                            <li class="page-item active" aria-current="page">
                              <a class="page-link" href="pages.php?sayfa=aktifdestek&page='.$i.'">'.$i.'<span class="sr-only">(current)</span></a>
                            </li>
                            ...
                            echo '
                    <li class="page-item"><a class="page-link" href="pages.php?sayfa=aktifdestek&page='.$i.'">'.$i.'</a></li>
                    ';
                        }
                    }
                    }
                    ...
                    <?php if($listele_tablo->rowCount() <=0) { } else { ?>
                        <?php if($Sayfa != $Sayfa_Sayisi){?>
                            ...
                            <li class="page-item"><a class="page-link" href="pages.php?sayfa=aktifdestek&page=<?=$Sayfa + 1?>"><?=$diller['sayfalama-sonraki']?></a></li>
                            <li class="page-item"><a class="page-link" href="pages.php?sayfa=aktifdestek&page=<?=$Sayfa_Sayisi?>"><?=$diller['sayfalama-son']?></a></li>
                ...
                <div class="alert alert-info" style="font-weight: 400">
                  Destek Talebi Bulunamadı!
                    <?php if(isset($_GET['search'])) {?>
                        <a href="pages.php?sayfa=aktifdestek">Geri Dön</a>
                    <?php }?>
                </div>
                <?php }?>
...
<div class="card p-l-5 p-b-15 p-t-20 bg-secondary">
    ...
    <form method="get" action="pages.php?" >
        <div class="form-row align-items-center">
            ...
            <div class="col-auto">
                <input type="hidden" class="form-control mb-2" id="inlineFormInput" name="sayfa" value="aktifdestek">
            </div>
...
<script type="text/javascript">
    ...
    function deletebutton(destekid,supportid){
        ...
        swal({
            ...
            if (isConfirm) {
                window.location.href = "support/post/delete/destek-aktif-sil.php?destek=success&id="+destekid+"&support_id="+supportid;
            } else {
...
<?php if( $_GET['status']=='success'){ ?>
    ...
    <meta http-equiv="refresh" content="1; URL=pages.php?sayfa=aktifdestek">
<?php }?>
