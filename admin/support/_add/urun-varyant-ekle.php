...
<title>Varyant Ekle | <?=$ayar['site_baslik']?></title>
<?php
$Siralama = $db->prepare("select * from varyant where urun_id='$_GET[urun_id]' ");
$Siralama->execute();
...
?>
<?php
if($degerCek->rowCount() == 0 || $Siralama->rowCount() >= 4 ) {
    header("Location:pages.php?sayfa=urunler");
}
?>
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><i class="mdi mdi-table-edit"></i> Varyant Ekle</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Varyant Ekle</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body" style="font-family: 'Open Sans', Arial">
                ...
                <form action="support/post/insert/varyant-ekle.php" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
