...
?>
    ...
    if (isset($_SESSION['basarili_guncelleme'])) {
        ...
        <div class="user_success_alert">
            <div class="user_success_alert_ic">
                <i class="fa fa-check"></i> <?=$diller['uyelik-adres-ekle-basarili']?>
            </div>
        </div>
    ...
    if (isset($_SESSION['kayit_hata']) && $_SESSION['kayit_hata'] == 'bos') {
        ...
        <meta http-equiv="refresh" content="2; URL=<?=$siteurl?>uyelik/adres-ekle">
        <?php unset($_SESSION['kayit_hata']);?>
    <?php }?>
<title><?php echo ucwords_tr($diller['uyelik-adres-ekle']) ?> | <?php echo $ayar['site_baslik']?></title>
    ...
    <div class="user-content-area">
        ...
        <div class="user-right-content">
            ...
            <div class="user-right-haed">
                <i class="ion-ios-location"></i> <?=$diller['uyelik-adres-ekle']?>
            </div>
            <div class="user-right-content-inside">
                    ...
                    <div class="user-right-form-area" style="width: 100%">
                        <form method="post" action="">
                            ...
                            <button type="submit" name="addaddress" class="btn btn-primary"><i class="fa fa-send"></i> <?=$diller['uyelik-adres-ekle-button']?></button>
                        </form>
                    </div>
